...
p. The above, for example, would set require Textpattern version 4.5.0 or newer. The plugin or theme will not be installed if the user's Textpattern version doesn't meet the requirements.